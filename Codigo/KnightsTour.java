...
public class KnightsTour {
     ...
     * Contiene ejemplos educativos para tableros 3x3, 4x4 y 5x5
     * @param args argumentos de línea de comandos (opcional tamaño de tablero)
     */
    public static void main(String[] args) {
        System.out.println("=====================================");
        System.out.println("   Solucion del Problema del Caballo  ");
        System.out.println("=====================================\n");
        
        // Ejemplo 1: Tablero pequeño 3x3
        System.out.println("1. EJEMPLO CON TABLERO 3x3");
        System.out.println("=========================");
        demoKnightsTour(3, 0, 0);
        
        System.out.println("\n2. EJEMPLO CON TABLERO 4x4");
        System.out.println("==========================");
        demoKnightsTour(4, 0, 0);
        
        // Permitir tamaño personalizado desde línea de comandos
        if (args.length > 0) {
            try {
                int customSize = Integer.parseInt(args[0]);
                if (customSize >= 3 && customSize <= 6) { // Limitar para pruebas
                    System.out.println("\n3. EJEMPLO PERSONALIZADO TABLERO " + customSize + "x" + customSize);
                    System.out.println("================================================");
                    demoKnightsTour(customSize, 0, 0);
                }
            } catch (NumberFormatException e) {
                System.out.println("\nTamaño inválido en parámetros.");
            }
        }
    }
    
    /**
     * Demuestra el funcionamiento del Knight's Tour con un tablero específico
     * @param size tamaño del tablero
     * @param startRow fila de inicio
     * @param startCol columna de inicio
     */
    private static void demoKnightsTour(int size, int startRow, int startCol) {
        try {
            ...
            if (solver.findSingleSolution(startRow, startCol)) {
                System.out.println("✓ Solución encontrada:");
                solver.displayBoard(solver.board);
            }
            
            // Para tableros pequeños, buscar todas las soluciones
            if (size <= 4) {
                System.out.println("Buscando todas las soluciones...");
                int totalSolutions = solver.findAllSolutions(startRow, startCol);
                System.out.println("Total de soluciones encontradas: " + totalSolutions);
            } else {
                System.out.println("Tablero grande: solo mostrando una solución para evitar largos tiempos de ejecución.");
            }
